...
const [options, setOptions] = useState<{
  ...
  async function saveConfiguration() {
    try {
        ...
        userImage.crossOrigin = "annonymous"
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
        <div 
            ...
            ref={containerRef}
        >
            <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-ratio-[896/1831]">
                <AspectRatio 
                    ratio={896/1831} 
            ...
            <Rnd 
                ...
                onResizeStop={(_, __, ref, ___, { x, y}) => {
                    setRenderedDimension({
                        heigth: parseInt(ref.style.height.slice(0, -2)),
            ...
            >
                <div className="relatie w-full h-full">
                    <NextImage 
                        src={imageUrl}
                        fill
                        alt="your-image"
        ...
        <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
            ...
            <div aria-hidden="true" className="absolute z-10 inset-x-0 bottom-0 h-12 bg-gradient-to-t from-white pointer-events-none"/>
                <div className="px-8 pb-12 pt-8">
                    ...
                    <div className="relative mt-4 -full flex flex-col justify-between">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="relative flex flex-col gp-3 w-full">
                                <Label>Model</Label>
                                <DropdownMenu>
