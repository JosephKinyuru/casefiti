    ...
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <p className="mt-2 text-4xl font-bold tracking-tight sm:text-5xl">Your case is on your way!</p>
        ...
        <div className="spacee-y-6 border-t border-zinc-200 pt-10 text-sm">
